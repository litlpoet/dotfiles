...
(setq doom-font (font-spec :family "JetBrains Mono" :size 10.0)
      ...
      doom-variable-pitch-font (font-spec :family "Noto Sans CJK KR" :size 10.0)
      ;; doom-unicode-font (font-spec :name "NanumGothicCoding" :size 13.0)
      )
(set-fontset-font "fontset-default" 'hangul (font-spec :family "NanumGothicCoding" :size 10.0))
#+end_src
...
;;         (cl-remove-if
;;          (lambda (it)
;;            (equal (car it) '(cmake-mode cmake-ts-mode)))
...
;;         gptel-model 'gemini-2.5-flash-preview-05-20))  ;; or 'gemini-2.5-pro
#+end_src
